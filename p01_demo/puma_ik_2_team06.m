function [th1 th2 th3 th4 th5 th6] = puma_ik_2_team06(x, y, z, phi, theta, psi, th1now, th2now, th3now, th4now, th5now, th6now)
...
for i = 1:4
    ...
    for j = 1:2
        ...
        if ~isnan(th1)
            ...
            theta_temp = [theta_col - 4*pi, theta_col-2*pi, theta_col, ...
                theta_col + 2*pi, theta_col + 4*pi];
