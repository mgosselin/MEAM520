function [ th1, th2, th3 ] = puma_ip_rd_team06( x_c, y_c, z_c )
%PUAM_IP_RD_TEAM06 calculates inverse position solution for right arm elbow
%down
...
% Calculate th2 and th3 for right arm, elbow down configuration
l = r;
s = z_c-a;
